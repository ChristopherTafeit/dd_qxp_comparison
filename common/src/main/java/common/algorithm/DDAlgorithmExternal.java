...
public class DDAlgorithmExternal {
    ...
    public DDAlgorithmExternal(Program<Element> testProgram) {
    ...
    private void ddmin(List<Element> input) {
        ...
        countCalls++;
        System.out.println("DD Algorithm was called: " + countCalls);
    ...
    private void ddmin2(List<Element> list, int n) {
        ...
        for (List<Element> l : complements) {
            TestResult resultComplement = testProgram.test(l);
